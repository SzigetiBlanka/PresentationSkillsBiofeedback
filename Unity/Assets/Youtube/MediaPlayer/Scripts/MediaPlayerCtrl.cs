...
public class MediaPlayerCtrl : MonoBehaviour
{
  ...
  public bool EndOfThePresentation;
  ...
  public void StopPlayVideo() {
    ...
    {
#if UNITY_STANDALONE
    Debug.Log("unity_standalone rész");
    string currentPath = Environment.GetEnvironmentVariable("PATH", EnvironmentVariableTarget.Process);
    ...
    if(SystemInfo.deviceModel.Contains("rockchip"))
        {
      Debug.Log("unity_standalone rész- rockchip tartalom");
      m_bSupportRockchip = true;
        }
        else
        {
      Debug.Log("unity_standalone rész- rockchip tartalom nélkül");
      m_bSupportRockchip = false;
        ...
        {
      Debug.Log("TargetMaterial: " + m_TargetMaterial.ToString()+ "/n length: "+m_TargetMaterial.Length);
