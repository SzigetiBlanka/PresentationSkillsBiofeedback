...
public class EdkErrorCode {
    ...
    // the EmoEngine.
    public static final int EDK_EMOENGINE_PROXY_ERROR = 0x0502;
    ...
    // 0.5s
    public static final int EDK_GYRO_NOT_CALIBRATED = 0x0700;

    // ! Operation failure due to optimization
    public static final int EDK_OPTIMIZATION_IS_ON = 0x0800;

    // ! Reserved return value
    public static final int EDK_RESERVED1 = 0x0900;
}
